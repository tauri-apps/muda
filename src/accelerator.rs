...
//! ```
//! # use muda::accelerator::{Accelerator, AcceleratorId, SysMods, RawMods};
//! # use muda::keyboard::{ModifiersState, KeyCode};
//! #
...
//! ```
//! # use muda::accelerator::{Accelerator, AcceleratorId, RawMods};
//! # use muda::keyboard::{ModifiersState, KeyCode};
//! #
