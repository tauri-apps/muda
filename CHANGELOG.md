...
- On Windows, fix panic when click a menu item while the `PredefinedMenuItem::about` dialog is open.
  - [1c09a41](https://www.github.com/tauri-apps/muda/commit/1c09a41554a8763aaf08d69ff83f7981642b55d7) fix(windows): run the about dialog in its own thread, closes [#57](https://www.github.com/tauri-apps/muda/pull/57) on 2023-03-27
