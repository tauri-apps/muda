...
- [`f881367`](https://www.github.com/tauri-apps/muda/commit/f88136766c26b951bee75e83ff45de5ec92ab310) ([#394](https://www.github.com/tauri-apps/muda/pull/394)) On GTK 3, detach accelerator groups from live windows when their menu is dropped.
- [`f881367`](https://www.github.com/tauri-apps/muda/commit/f88136766c26b951bee75e83ff45de5ec92ab310) ([#394](https://www.github.com/tauri-apps/muda/pull/394)) On GTK 3, update and remove menu item accelerators from the correct group when an item belongs to multiple root menus.
...
- [`f881367`](https://www.github.com/tauri-apps/muda/commit/f88136766c26b951bee75e83ff45de5ec92ab310) ([#394](https://www.github.com/tauri-apps/muda/pull/394)) On macOS, clear the application's services/windows/help/main menu slots when the menu occupying them is removed or dropped, so `NSApplication` no longer holds on to a stale menu.
...
- [`f881367`](https://www.github.com/tauri-apps/muda/commit/f88136766c26b951bee75e83ff45de5ec92ab310) ([#394](https://www.github.com/tauri-apps/muda/pull/394)) On Windows, fix leaking GDI bitmap handles when menu item icons are replaced or their items are dropped.
- [`f881367`](https://www.github.com/tauri-apps/muda/commit/f88136766c26b951bee75e83ff45de5ec92ab310) ([#394](https://www.github.com/tauri-apps/muda/pull/394)) On Windows, detach menu and submenu window subclass handlers when their owners are dropped to prevent dangling callbacks.
- [`ada2895`](https://www.github.com/tauri-apps/muda/commit/ada28959b2cb63881c8935be73d578b39fe170e6) Renamed `gtk` feature flag to `gtk3` feature flag.
...
- [`6ec28be`](https://www.github.com/tauri-apps/muda/commit/6ec28beecacc6ca6697d834ebb61dffe9f85e187) ([#396](https://www.github.com/tauri-apps/muda/pull/396)) Add `builder` associated functions to `MenuItem`, `CheckMenuItem`, `IconMenuItem`, and `Submenu`.
- [`6856531`](https://www.github.com/tauri-apps/muda/commit/68565319d96a3df64cc1ba0359be33414a5fa3cf) ([#395](https://www.github.com/tauri-apps/muda/pull/395)) Make menu item and submenu builders create enabled items by default rather than disabled ones.
- [`b3d70d1`](https://www.github.com/tauri-apps/muda/commit/b3d70d18d0490a8b32743f86e5bc46857f2fe78f) ([#387](https://www.github.com/tauri-apps/muda/pull/387)) Upgrade `keyboard-types` to 0.8 and use `META` as the primary variant for the Super modifier.
- [`253ea1e`](https://www.github.com/tauri-apps/muda/commit/253ea1efc75a08cb2cb0bb44ede294888736243f) ([#352](https://www.github.com/tauri-apps/muda/pull/352)) On macOS, context-menu popups are clamped to avoid overflowing off the bottom or right edge of the screen.
- [`d00ab36`](https://www.github.com/tauri-apps/muda/commit/d00ab36630112bebb919de53e22976ca2bc36800) ([#408](https://www.github.com/tauri-apps/muda/pull/408)) Add `PredefinedMenuItem::section_header` for native menu section headers on macOS 14 and later. Section headers are rendered as disabled menu items on unsupported macOS versions and other platforms.
- [`d348f27`](https://www.github.com/tauri-apps/muda/commit/d348f272c1d12271b17a1f0c9153aa0660ec9ed0) ([#353](https://www.github.com/tauri-apps/muda/pull/353)) Add `MenuItem/IconMenuItem/CheckMenuItem/Submenu::set_styled_text` and `MenuItemBuilder/IconMenuItemBuilder/CheckMenuItemBuilder/SubmenuBuilder::styled_text` to set a label as a sequence of text parts carrying a semantic `TextStyle`, so `TextStyle::Secondary` can de-emphasize part of a label. Supported only on macOS for now.
...
- [`f881367`](https://www.github.com/tauri-apps/muda/commit/f88136766c26b951bee75e83ff45de5ec92ab310) ([#394](https://www.github.com/tauri-apps/muda/pull/394)) Adding a submenu to itself, or to one of its own descendants, now fails with the new `Error::WouldCreateCycle` instead of creating a cycle in the menu tree.
- [`abe2d79`](https://www.github.com/tauri-apps/muda/commit/abe2d793d3c208ec3b0ee225137277d8c3aca28c) ([#239](https://www.github.com/tauri-apps/muda/pull/239)) Add the `snapshot` Cargo feature with live, thread-safe menu snapshots for reading and activating menu items from other threads. Inteneded to be used with `tray-icon` upcoming KSNI backend.
